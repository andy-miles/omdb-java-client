...
import com.amilesend.omdb.client.model.GetByTitleRequestBase;
 ...
 * @see GetSeriesBasedRequest
 */
@SuperBuilder
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class GetSeriesByTitleRequest extends GetByTitleRequestBase implements GetSeriesBasedRequest {
    @Override
